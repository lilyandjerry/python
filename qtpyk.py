...
class report_painter:
    ...
    def PriceGridPaint(self):
        ...
        self.setPen('yellow')
        self.paint.drawText(self.w-self.grid_padding_right+5,self.h-self.grid_padding_bottom-4,QtCore.QString('成交量'))
        self.setPen('white')
        #右下角文字
        self.paint.drawText(self.w-self.grid_padding_right+12,self.h-self.grid_padding_bottom+12,QtCore.QString('实时'))
    '''绘制成交量走势表格'''
    ...
    def rightGridPaint(self):
        ...
        zx_str = QtCore.QString('最新')
        self.paint.drawText(_x+3  ,156,zx_str)
        self.setPen('gray')
        wb_str = QtCore.QString('委比')
        wc_str = QtCore.QString('委差')
        xs_str = QtCore.QString('现手')
        ...
        wp_str = QtCore.QString('外盘')
        np_str = QtCore.QString('内盘')
    ...
    def topInfoPaint(self):
        ...
        #涨停价
        self.setPen('red')
        self.paint.drawText(4+self.grid_padding_left+200,self.grid_padding_top-4,QtCore.QString('涨停价:%.2f'%(lastclose*1.1))) #均价
        #跌停价
        self.setPen('green')
        self.paint.drawText(4+self.grid_padding_left+280,self.grid_padding_top-4,QtCore.QString('跌停价:%.2f'%(lastclose*0.9))) #均价
    '''绘制股价走势'''
    def pricePaint(self):
        sum_width  = self.grid_padding_left+self.grid_padding_right
        sum_height = self.grid_padding_top+self.grid_padding_bottom
...
class Test(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(QtCore.QString('超级狙击手[内部开发测试版]-行情实时走势'))
